package com.skywriter.scheduele;

import com.skywriter.scheduele.client.OAuth2InterceptedFeignConfiguration;
import com.skywriter.scheduele.config.ApplicationProperties;
import com.skywriter.scheduele.config.DefaultProfileUtil;
...
public class ScheduleApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ScheduleApp.class);

    private final Environment env;

    public ScheduleApp(Environment env) {
        this.env = env;
    }
